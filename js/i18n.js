...
export const MESSAGES = {
  ...
  en: {
    ...
    "fin.expenses.hint":   "Rent, phone, transport — anything that isn't a scanned grocery receipt. Pick how each was paid.",
    "fin.receipts.title":  "Grocery receipts",
    "fin.receipts.hint":   "Snap a receipt and confirm the line items — nothing is sent anywhere, you type what you see.",
    ...
    "btn.snapReceipt":     "📷 Scan receipt",
    "btn.manualReceipt":   "Add manually",
    "fin.noReceipts":      "No receipts yet — scan one.",

    /* ── Receipt modal ── */
    "receipt.title":       "Confirm receipt",
    "receipt.hint":        "Check each line against the photo, fix anything off, then add.",
    "label.store":         "Store",
  ...
  ja: {
    ...
    "fin.expenses.hint":   "家賃・携帯料金・交通費など、スキャンしたレシート以外の支出です。支払い方法を選択してください。",
    "fin.receipts.title":  "食料品レシート",
    "fin.receipts.hint":   "レシートを撮影して明細を確認 — データはどこにも送信されません。見ながら手入力してください。",
    ...
    "btn.snapReceipt":     "📷 レシートを読み込む",
    "btn.manualReceipt":   "手動で入力",
    "fin.noReceipts":      "まだレシートがありません — 読み込んでください。",

    /* ── Receipt modal ── */
    "receipt.title":       "レシートの確認",
    "receipt.hint":        "写真と照らし合わせて確認し、修正があれば直してから追加してください。",
    "label.store":         "店名",
  ...
  vi: {
    ...
    "fin.expenses.hint":   "Tiền thuê nhà, điện thoại, đi lại — tất cả chi tiêu không phải từ hóa đơn siêu thị đã quét. Chọn hình thức thanh toán cho từng khoản.",
    "fin.receipts.title":  "Hóa đơn siêu thị",
    "fin.receipts.hint":   "Chụp hóa đơn và xác nhận các mục — không có gì được gửi đi, bạn tự nhập theo những gì thấy.",
    ...
    "btn.snapReceipt":     "📷 Quét hóa đơn",
    "btn.manualReceipt":   "Nhập thủ công",
    "fin.noReceipts":      "Chưa có hóa đơn — hãy quét một cái.",

    /* ── Receipt modal ── */
    "receipt.title":       "Xác nhận hóa đơn",
    "receipt.hint":        "Đối chiếu với ảnh, sửa nếu sai, rồi thêm vào.",
